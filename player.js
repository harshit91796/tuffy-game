...
export class Player{
    ...
    update(input,deltaTime){
      ...
      // vertical boundaries
      if(this.y > this.game.height - this.height - this.game.groundMargin)this.y = this.game.height - this.height
        ...
        this.game.enemies.forEach(enemy => {
            if(
                ...
                if(this.currentState === this.states[4]|| this.currentState=== this.states[5]){
                    this.game.score++;
                    this.game.floatingMessage.push(new FloatingMessage('+1',enemy.x,enemy.y,0,0));
                 } else{
                      this.setState(6,0);
                      this.game.lives--;
